...
export default function EmaeaBody({entityId}){
  ...
  return <div className="relative mx-auto w-full">
    <style>{`
      ...
      body:has([aria-label="EMÆÄ"]) main .mb-4.grid.grid-cols-2.gap-2::before{content:"0";background-image:radial-gradient(circle at 32% 28%,rgba(255,255,255,.95) 0 5%,#93c5fd 12%,#3b82f6 43%,#1d4ed8 73%,#172554 100%),linear-gradient(180deg,rgba(6,78,59,.66),rgba(4,47,46,.60));order:5}
      body:has([aria-label="EMÆÄ"]) main .mb-4.grid.grid-cols-2.gap-2::after{content:"0";border-color:rgba(250,204,21,.56);background-image:radial-gradient(circle at 31% 25%,rgba(255,255,255,.98) 0 5%,#fff1a8 10%,#f6c84b 33%,#c98a16 61%,#6f4307 84%,#2f1a02 100%),linear-gradient(180deg,rgba(113,63,18,.68),rgba(66,42,10,.64));color:rgba(254,240,138,.9);box-shadow:inset 0 1px 0 rgba(254,240,138,.10),0 0 18px rgba(234,179,8,.06);order:6}
