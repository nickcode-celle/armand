...
export default function EmaeaBody({entityId}){
  ...
  useEffect(()=>{
    ...
    const install=()=>{
      ...
      const makeClone=(source,kind)=>{
        ...
        if(marble){
          marble.style.width='24px';
          marble.style.height='24px';
          marble.style.minWidth='24px';
          marble.style.minHeight='24px';
          marble.style.borderRadius='999px';
          if(kind==='blue'){
  ...
  return <div className="relative mx-auto w-full">
    <style>{`
      ...
      body:has([aria-label="EMÆÄ"]) main .mb-4.grid.grid-cols-2.gap-2::after{content:none!important;display:none!important}
