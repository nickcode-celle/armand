export const ENTITY_SCHEMA_VERSION=13;
...
const evolutionDefaults=()=>({durable_levels:{},marbles:[],history_events:[],history_level:null,birth_thresholds:{},birth_history:[],observer_last:null,last_changes:[],last_marble_changes:[],updated_at:null});
