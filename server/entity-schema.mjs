export const ENTITY_SCHEMA_VERSION=10;
...
const emotionDefaults=()=>({active:[],last_changes:[],updated_at:null});
const migrations={
...
export function migrateEntityState(input={}){
  ...
  return{...s,schema_version:ENTITY_SCHEMA_VERSION,metrics:{...metricDefaults,...(s.metrics||{})},evolution:{...evolutionDefaults(),...(s.evolution||{})},emotion:{...emotionDefaults(),...(s.emotion||{})}};
}
