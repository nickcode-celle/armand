...
let snapshot={
  state:{revision:3,recent_messages:[{role:'user',content:'Je reviens sur ce sujet et je te fais confiance.'}],evolution:{durable_levels:{Relation:{Confiance:50}},history_events:[]}},
...
const out=await handle({entityId:'emae-test',message:'x',messages:[{role:'user',content:'x'}]});
